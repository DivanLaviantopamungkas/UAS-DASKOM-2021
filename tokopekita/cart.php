...
<meta name="keywords" content="Tokopekita, Devan, Lab" />
	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					<li><i class="fa fa-phone" aria-hidden="true"></i>Hubungi Kami : (+62) 8122 6594 919</li>
				</ul>
			</div>
...
<div class="footer">
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Devan, Kudus jateng.</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="idsatria12@email">info@email</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>+62 8122 6594 919</li>
					</ul>
				</div>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2022 Divan Lavianto Pa. All rights reserved</p>
			</div>
		</div>
